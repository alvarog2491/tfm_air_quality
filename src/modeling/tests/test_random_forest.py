...
def sample_data():
    ...
    y = pd.Series(2 * X["feature1"] + X["feature2"] + 0.5 * X["feature3"] + np.random.randn(100) * 0.1)
...
def sample_metrics_config():
    ...
    return {
        "enabled_metrics": ["mse", "rmse", "mae", "r2"]
    }
...
class TestRandomForestModel:
    ...
    def test_model_initialization_with_config(self, sample_hyperparameters, sample_metrics_config):
    ...
    def test_model_evaluation_default_metrics(self, sample_data, sample_hyperparameters):
    ...
    def test_model_evaluation_custom_metrics(self, sample_data, sample_hyperparameters, sample_metrics_config):
