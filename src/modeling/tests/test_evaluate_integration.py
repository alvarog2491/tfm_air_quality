...
from src.modeling.evaluate import main
...
class TestEvaluateIntegration:
    ...
    @patch("src.modeling.evaluate.load_yaml_config")
    @patch("src.modeling.evaluate.prepare_features_and_target")
    def test_evaluate_pipeline_end_to_end(
        self, mock_prepare_features, mock_load_config,
        sample_config, sample_evaluation_dataset, trained_model, tmp_path
    ):
