...
from common.utils.file_utils import validate_file_exists, ValidationError
from modeling.utils.dataset_modeling_utils import (
    one_hot_encode_categorical_features,
    scale_numerical_features,
    separate_train_evaluate_dataset,
)
from modeling.utils.model_validation import validate_preprocessing_config
...
def main(
    ...
    try:
        ...
        validate_file_exists(raw_dataset, "Raw dataset file")
        ...
        validate_dataframe_not_empty(dataset, "Raw dataset")
        
    except ValidationError as e:
        logger.error(f"Validation error: {e}")
        raise
    except Exception as e:
        logger.error(f"Error during preprocessing initialization: {e}")
        raise
