...
from utils.air_quality_rules import quality_labels, quality_thresholds
...
class AirQualityProcessor(BaseProcessor):
    ...
    def classify_quality(self) -> None:
        ...
        self._air_quality_df["Air Pollutant"] = self._air_quality_df[
            "Air Pollutant"
        ].str.lower()
        ...
        self._air_quality_df["Quality"] = self._air_quality_df.apply(
            get_quality, axis=1
        )
        ...
        self._air_quality_df["Quality"] = self._air_quality_df["Quality"].astype(
            "category"
        )
    ...
    def map_province_names(self) -> None:
        ...
        """
        self._air_quality_df = ProvinceMapper.map_province_name(
            "Air quality", self._air_quality_df
        )
